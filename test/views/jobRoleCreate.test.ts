...
const templatePath = path.resolve(process.cwd(), "src/views/pages/jobRoleCreate.njk");
...
describe("jobRoleCreate", () => {
  ...
  it("should keep status fixed to OPEN and allow an optional closing date", () => {
    ...
    expect(html).toContain("If no closing date is set, the role will remain open until manually closed.");
