...
describe("routes", () => {
	...
	it("should not expose an applications page to users", async () => {
	...
	it("should not expose application CV pages to users", async () => {
		const userApp = createAdminApp("USER");
	...
	it("should not expose application withdrawal to users", async () => {
		const userApp = createAdminApp("USER");
