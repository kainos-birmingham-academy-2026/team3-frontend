...
export class JobRoleService {
  ...
  async getAllStatuses(): Promise<StatusOption[]> {
    try {
      const response = await apiClient.get<StatusOption[]>("/job-roles/statuses");
  ...
  async getAllLocations(): Promise<LocationOption[]> {
    try {
      const response = await apiClient.get<LocationOption[]>("/job-roles/locations");
      return response.data;
    } catch {
  ...
  async getAllCapabilities(): Promise<CapabilityOption[]> {
    try {
      const response = await apiClient.get<CapabilityOption[]>("/job-roles/capabilities");
      return response.data;
    } catch {
